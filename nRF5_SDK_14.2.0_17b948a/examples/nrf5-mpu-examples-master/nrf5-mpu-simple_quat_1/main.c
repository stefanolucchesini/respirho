...
{    
    ...
    while(1)
    {
        if(NRF_LOG_PROCESS() == false)
        {
            ...
            APP_ERROR_CHECK(err_code);
					  acc.x=((acc_values.x)/16384.)-0.05;
					  acc.y=((acc_values.y)/16384.)-0.04;
            ...
            APP_ERROR_CHECK(err_code);
					  ...
					  //mz=(((magn_values.z*(-90.81))/0.776)-6202.2)*0.9768;
						mx=(((magn_values.x*(-78.82))/0.667)+31374.)*1.0236;
					  my=(((magn_values.y*(-80.85))/0.667)+1515.2)*1.0412;
					  mz=(((magn_values.z*(-90.81))/0.667)-29204.)*0.9411;
            ...
            err_code = app_mpu_read_accel(&acc_values);
            APP_ERROR_CHECK(err_code);
					  acc.x=((acc_values.x)/16384.)-0.03;
					  acc.y=((acc_values.y)/16384.);
					  acc.z=((acc_values.z)/16384.)-0.02;
            ...
            APP_ERROR_CHECK(err_code);
					  ...
					  //my=(((magn_values.y*(-80.85))/0.776)-4896.8)*1.0315;
					  //mz=(((magn_values.z*(-90.81))/0.776)-6202.2)*0.9768;
						mx=(((magn_values.x*(-74.79))/0.667)+29707.)*1.0254;
					  my=(((magn_values.y*(-74.83))/0.667)+673.1334)*1.0583;
					  mz=(((magn_values.z*(-85.79))/0.667)-41930.)*0.9260;
